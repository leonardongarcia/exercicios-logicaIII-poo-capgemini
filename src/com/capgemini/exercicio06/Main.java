...
/*
6. Crie uma classe chamada Invoice que possa ser utilizado por uma loja de suprimentos de informática para representar
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Invoice invoice = new Invoice("5263", "Arroz carreteiro", 10, 50);
